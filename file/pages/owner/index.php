				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-body">
                            ...
                            <button type="button" class="btn btn-success" onclick="location.href='../admin/daftar_pesanan_laporan.php'"> PDF</button>
							<hr>

                            <h3>Laporan Bukti Pesan</h3><br>
                        
                            <button type="button" class="btn btn-success" onclick="location.href='../admin/daftar_bukti_pesan_laporan.php'"> PDF</button>
