...
<head>
	<title>Master Data | View user</title>
	<meta charset="utf-8">
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">View Pelanggan</h3>
                                </div>
								...
								<div class="panel-body">
									<table class="table">
                                        ...
                                        <tr>
                                        <td>Nama Pelanggan <br><input type="text" class="form-control" name="nama_user" value="<?php echo $data['nama_user']; ?>" disabled></td>
                                        </tr>

                                        <tr>
                                        <td>Alamat <br> <input type="text" class="form-control" name="alamat" value="<?php echo $data['alamat']; ?>" disabled></td>
                                        </tr>

                                        <tr>
                                        <td>No Telp <br><input type="text" class="form-control" name="no_telp" value="<?php echo $data['no_telp']; ?>" disabled></td>
                                        </tr>

                                        <tr>
                                        <td>Username <br><input type="text" class="form-control" name="username" value="<?php echo $data['username']; ?>" disabled></td>
                                        </tr>

                                        <tr>
                                        <td>Password <br> <input type="text" class="form-control" name="password" value="<?php echo $data['password']; ?>" disabled></td>
