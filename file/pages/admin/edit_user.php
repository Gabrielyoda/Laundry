...
<head>
	<title>Master Data | Edit Pelanggan</title>
	<meta charset="utf-8">
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Edit Pelanggan</h3>
                                </div>
                                <form action="edit_user_proses.php" method="post" onsubmit="return validasi(this)">
								<div class="panel-body">
									<table class="table">
										
										
                                        <tr>
                                        <td>Nama Pelanggan <br><input type="text" class="form-control" name="nama_user" value="<?php echo $data['nama_user']; ?>"></td>
                                        </tr>

                                        <tr>
                                        <td>Alamat <br> <input type="text" class="form-control" name="alamat" value="<?php echo $data['alamat']; ?>"></td>
                                        </tr>

                                        <tr>
                                        <td>No Telp <br><input type="text" class="form-control" name="no_telp" value="<?php echo $data['no_telp']; ?>"></td>
                                        </tr>

                                        <tr>
                                        <td>Username <br><input type="text" class="form-control" name="username" value="<?php echo $data['username']; ?>"></td>
                                        </tr>
                                        ...
                                        <tr>
                                        <td>Re-Password <br> <input type="password" class="form-control" name="repassword" >
