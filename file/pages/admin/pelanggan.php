							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									while($rec = mysqli_fetch_array($result)){
										...
										echo '<td>'.$rec['alamat'].'</td>';
										echo '<td>'.$rec['no_telp'].'</td>';
										echo '<td>	<a href=view_user.php?id_user='.$rec['id_user'].' class="btn btn-success" onclick="return confirm(\'Anda ingin melihat data ini?\')"><i class ="fa fa-eye"></i></a>            <a href=edit_user.php?id_user='.$rec['id_user'].' class="btn btn-primary" onclick="return confirm(\'Anda ingin edit data ini ?\')"><i class ="fa fa-pencil"></i></a>
									...
									<button type="button" class="btn btn-success" onclick="location.href='tambah_pelanggan.php'"><i class="fa fa-plus"></i> Tambah data</button>
								</div>
							</div>
							<!-- END BASIC TABLE -->
						</div>
