...
<head>
	<title>Daftar Pesanan | Tabel Daftar Pesanan</title>
	<meta charset="utf-8">
...
$query = "select*from daftar_pesanan inner join user on daftar_pesanan.id_user=user.id_user where status='belum selesai'";
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
                ...
                <ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class=""><i class="lnr lnr-pencil"></i> <span>Master Data</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
						...
						<li><a href="daftar_pesanan.php" class="active"><i class="lnr lnr-inbox"></i> <span>Daftar Pesanan Laundry</span></a></li>
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									while($rec = mysqli_fetch_array($result)){
										...
										echo '<td><a href=bukti_pesan_proses.php?id_daftar_pesanan='.$rec['id_daftar_pesanan'].' class="btn btn-success" onclick="return confirm(\'Apakah pesanan ini sudah selesai ?\')"><i class ="fa fa-check"></i></a>
										</td>';
									...
									<button type="button" class="btn btn-success" onclick="location.href='tambah_pesanan.php'"><i class="fa fa-plus"></i> Tambah data</button>
								</div>
							</div>
							<!-- END BASIC TABLE -->
						</div>
