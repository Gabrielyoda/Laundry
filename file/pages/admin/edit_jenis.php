...
<head>
	<title>Master Data | Edit Jenis</title>
	<meta charset="utf-8">
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Input Jenis barang</h3>
                                </div>
                                <form action="edit_jenis_proses.php" method="post" onsubmit="return validasi(this)">
								<div class="panel-body">
									<table class="table">
										
                                        <tr>
                                        <td>Jenis Barang <br><input type="text" class="form-control" name="jenis_barang" value="<?php echo $data['jenis_barang']; ?>"></td>
                                        </tr>

                                        <input type="hidden" name="id_jenis" value="<?php echo $data['id_jenis']; ?>"></td>
                                        </tr>
