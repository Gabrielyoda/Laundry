		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
                ...
                <ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class="active"><i class="lnr lnr-pencil"></i> <span>Master Data</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="pelanggan.php" class="">Pelanggan</a></li>
									<li><a href="barang.php" class="">Barang</a></li>
									<li><a href="jenis.php" class="active">Jenis barang</a></li>
								</ul>
							</div>
						</li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Daftar Jenis</h3>
								</div>
								<div class="panel-body">
									...
									while($rec = mysqli_fetch_array($result)){
										echo'<tr>';
										echo '<td>'.$rec['id_jenis'].'</td>';
										echo '<td>'.$rec['jenis_barang'].'</td>';
										echo '<td>	<a href=edit_jenis.php?id_jenis='.$rec['id_jenis'].' class="btn btn-primary" onclick="return confirm(\'Anda ingin edit data ini ?\')"><i class ="fa fa-pencil"></i></a>
										<a href=delete_jenis.php?id_jenis='.$rec['id_jenis'].' class="btn btn-danger" onclick="return confirm(\'Yakin?\')"><i class ="fa fa-trash"></i></a>
										</td>';
										echo'<tr>';
									}
									?>
									...
									<button type="button" class="btn btn-success" onclick="location.href='tambah_jenis.php'"><i class="fa fa-plus"></i> Tambah data</button>
								</div>
							</div>
							<!-- END BASIC TABLE -->
						</div>
