							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									while($rec = mysqli_fetch_array($result)){
										echo'<tr>';
										echo '<td>'.$rec['id_barang'].'</td>';
										echo '<td>'.$rec['nama_barang'].'</td>';
										echo '<td>'.$rec['jenis_barang'].'</td>';
                                        echo '<td>'.$rec['harga_laundry'].'</td>';
										echo '<td>	<a href=edit_barang.php?id_barang='.$rec['id_barang'].' class="btn btn-primary" onclick="return confirm(\'Anda ingin edit data ini ?\')"><i class ="fa fa-pencil"></i></a>
										<a href=delete_barang.php?id_barang='.$rec['id_barang'].' class="btn btn-danger" onclick="return confirm(\'Yakin?\')"><i class ="fa fa-trash"></i></a>
										</td>';
										echo'<tr>';
									}
									?>
									...
									<button type="button" class="btn btn-success" onclick="location.href='tambah_barang.php'"><i class="fa fa-plus"></i> Tambah data</button>
								</div>
							</div>
							<!-- END BASIC TABLE -->
						</div>
