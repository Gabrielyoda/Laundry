...
<head>
	<title>Dashboard | Laundry Web</title>
	<meta charset="utf-8">
...
$query_data_pelanggan = "SELECT COUNT(level) as jumlah from user where level='2'";
$result_data_pelanggan = mysqli_query($connection,$query_data_pelanggan);
$data_pelanggan = mysqli_fetch_array($result_data_pelanggan);

$query_data_barang = "SELECT COUNT(id_barang) as jumlah from barang";
$result_data_barang = mysqli_query($connection,$query_data_barang);
$data_barang = mysqli_fetch_array($result_data_barang);
					...
					<div class="panel panel-headline">
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><?php echo $data_pelanggan['jumlah'];?></span>
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><?php echo $data_barang['jumlah'];?></span>
							...
							<div class="row">
								<div class="col-md-12">
									<center>
								<h1>Daftar Pesanan yang belum diselesaikan</h1>
							<hr>
							<table class="table">
										<thead>
											<tr>
