...
<head>
	<title>Master Data | Edit barang</title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel">
                                ...
                                <form action="edit_barang_proses.php" method="post" onsubmit="return validasi(this)">
								<div class="panel-body">
									<table class="table">
										
                                        <tr>
                                        <td>Nama Barang <br><input type="text" class="form-control" name="nama_barang" value="<?php echo $data['nama_barang']; ?>"></td>
                                        </tr>
                                        ...
                                        <br>
										<?php
                                        $query2 = "select*from jenis_barang";
                                        ...
                                        <tr>
                                        <td>Harga Laundry <br><input type="text" class="form-control" name="harga_laundry"  value="<?php echo $data['harga_laundry']; ?>"></td>
                                        </tr>

                                        

										<tr>
										<td><input type="submit" class="btn btn-success" name="submit" value="simpan"><input type="hidden" name="id_barang" value="<?php echo $data['id_barang']; ?>"></td>
										</tr>
									</table>
								</div>
							</div>
