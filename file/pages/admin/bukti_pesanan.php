...
<head>
	<title>Bukti Pesan | Bukti Pesan</title>
	<meta charset="utf-8">
...
$query = "select*from daftar_pesanan inner join user on daftar_pesanan.id_user=user.id_user where status='selesai'";
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
                ...
                <ul class="nav">
                        ...
                        <li><a href="bukti_pesanan.php" class="active"><i class="lnr lnr-cart"></i> <span>Bukti Pesanan</span></a></li>
