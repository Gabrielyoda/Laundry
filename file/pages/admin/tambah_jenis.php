...
<head>
	<title>Master Data | Tambah Jenis</title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel">
                                ...
                                <form action="tambah_jenis_proses.php" method="post" onsubmit="return validasi(this)">
								<div class="panel-body">
									<table class="table">
										
                                        <tr>
                                        <td>Jenis Barang <br><input type="text" class="form-control" name="jenis_barang" ></td>
                                        </tr>
